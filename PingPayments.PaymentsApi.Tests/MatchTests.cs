...
namespace PingPayments.PaymentsApi.Tests
{
    ...
    {
        public record StringResponseBody(string Text) : EmptySuccesfulResponseBody;
        ...
        {
            var succesfulResponse = new FakeResponse(HttpStatusCode.OK, true, new StringResponseBody("Foobar"), "Foobar");
            succesfulResponse.Match
            (
        ...
        {
            var succesfulResponse = new FakeResponse(HttpStatusCode.OK, true, new StringResponseBody("Foobar"), "Foobar");
            await succesfulResponse.MatchAsync
            (
