...
```c#
services.AddHttpClient<IPingPaymentsApiClient>(client =>
{
    var apiUrl = AppSettings.GetValue("PingPayments:ApiUrl");
    var tenantId = Guid.Parse(AppSettings.GetValue("PingPayments:TenantId"));
