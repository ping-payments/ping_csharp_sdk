...
## 4.0.12 (2026-04-24)
- Updated models for KYC

## 4.0.11 (2026-03-30)
- Updated models and actions for Bankgirot.Autogiro and Swish.Recurring according to the API release 2025-11-19

## 4.0.7 -- 4.0.10 (2026-03)
- Internal build updates

## 4.0.6 (2026-03-05)
- Updated models for Allocation

## 4.0.5 (2025-11-18)
- Updated models for BankAccount

## 4.0.4 (2025-11-17)
- Updated models for merchant KYC information

## 4.0.3 (2025-10-07)
- Added support for Klarna

## 4.0.2 (2025-10-03)
- Added support for Vipps MobilePay

## 4.0.0 (2025-08-12)
- Breaking changes. List is now split into ListData and ListPage.
