...
namespace PingPayments.Mimic.Disbursements.Trigger.V1
{
    public record TriggerDisbursementResponse : ApiResponseBase<TriggerDisbursementResponseBody>
    {
        ...
        public static TriggerDisbursementResponse Successful(HttpStatusCode statusCode, TriggerDisbursementResponseBody body, string rawBody) => new(statusCode, true, body, rawBody);
